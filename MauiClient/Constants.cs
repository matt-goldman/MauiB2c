namespace MauiClient
{
    ...
    {
        public static string[] B2cScopes { get; set; } = new string[] { "openid", "https://goldiessw.onmicrosoft.com/maui-server/access_as_user" };
        ...
        public static string HttpClientName = "GoldieHttpClient";
    }
}
